...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'nguyenvana@gmail.com', description: 'Địa chỉ email người dùng' }),
    (0, class_validator_1.IsEmail)({}, { message: 'Email không hợp lệ' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'Email không được để trống' }),
    __metadata("design:type", String)
], RegisterDto.prototype, "email", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Password123@', description: 'Mật khẩu bảo mật (tối thiểu 6 ký tự)' }),
