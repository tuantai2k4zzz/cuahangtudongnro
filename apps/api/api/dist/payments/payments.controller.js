...
__decorate([
    (0, common_1.Post)('create-qr/:orderId'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Khởi tạo thông tin mã VietQR cho đơn hàng' }),
...
__decorate([
    (0, common_1.Get)('check-status/:orderCode'),
    (0, swagger_1.ApiOperation)({ summary: 'Kiểm tra trạng thái đơn hàng (Polling từ modal frontend)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Tiếp nhận webhook thanh toán tự động (VietQR, SePAY, PayOS, MoMo)' }),
...
__decorate([
    (0, common_1.Post)('deposit/create'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Khởi tạo yêu cầu nạp tiền vào ví Coin' }),
...
__decorate([
    (0, common_1.Get)('deposit/status/:code'),
    (0, swagger_1.ApiOperation)({ summary: 'Kiểm tra trạng thái yêu cầu nạp tiền (Polling từ modal nạp)' }),
    __param(0, (0, common_1.Param)('code')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], PaymentsController.prototype, "checkDepositStatus", null);
__decorate([
    (0, common_1.Get)('deposit/me'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Lịch sử nạp tiền của tôi' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('userId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], PaymentsController.prototype, "getMyDeposits", null);
