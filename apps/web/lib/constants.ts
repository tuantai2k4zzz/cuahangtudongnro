export const SITE_CONFIG = {
  ...
  vietqrConfig: {
    ...
    accountNumber: '0865903707',
    accountHolder: 'BUI TUAN TAI',
  },
};

export const NAV_LINKS = [
  { label: 'Trang Chủ', href: '/' },
  { label: 'Danh Sách Tool', href: '/tools' },
  { label: 'Bảng Giá & Gói', href: '/pricing' },
];

export const CATEGORY_LABELS: Record<string, string> = {
  ALL_IN_ONE: 'Toàn Diện (All-in-One)',
  AUTO_TRAIN: 'Auto Treo & Úp Đệ',
  SAN_BOSS: 'Săn Boss & Săn Item',
  AUTO_NHIEM_VU: 'Auto Làm Nhiệm Vụ',
  TIEN_ICH: 'Tiện Ích & Mod Hỗ Trợ',
};
